...
export function todo({ id, title, isComplete }) {
  return `
  <li class="list__item ${isComplete ? "list__item--checked" : ""}" data-id="${id}" draggable="true">
    <section class="checkbox-container">
      ...
      <svg class="done-svg" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
